...
class QuantizeLayoutTransform(quantize_layout_transform.QuantizeLayoutTransform):
  ...
  def apply(self, model, layer_quantize_map):
    ...
    Returns:
      ...
      layer quantize map.)
    """
    print("WARNING: In QuantizeLayoutTransform, input transform disabled")
    transforms = [
    ...
    return model_transformer.ModelTransformer(model, transforms, layer_quantize_map.keys(), layer_quantize_map).transform()
